  ...
  const LogoIcon = () => (
    <div className={cn("relative", sizeClasses[size])}>
      ...
      >
        ...
        {/* Cookie Fold/Crease - makes it look like a fortune cookie */}
        <path
        ...
        {/* Cookie crumbs/texture dots */}
        <circle cx="22" cy="30" r="0.5" fill="#92400E" opacity="0.3" />
        <circle cx="42" cy="34" r="0.5" fill="#92400E" opacity="0.3" />
        <circle cx="28" cy="38" r="0.5" fill="#92400E" opacity="0.3" />
      </svg>
    </div>
  );
