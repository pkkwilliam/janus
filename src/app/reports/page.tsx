...
import { Calendar, Star, Clock, Eye, ChevronRight, ChevronLeft, Filter, Loader2, ArrowLeft } from 'lucide-react';
        ...
        >
          ...
          <div className="space-y-3 mb-4">
            ...
            <div className="flex flex-wrap gap-1">
              {report.reportContent.keyThemes.slice(0, 3).map((theme: string, idx: number) => (
                <span
                  key={idx}
...
export default function ReportsPage() {
  ...
  const handleFilterChange = (filter: 'ALL' | 'YEARLY' | 'MONTHLY' | 'WEEKLY') => {
      ...
      >
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-600">Your complete fortune reading history</p>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div className="flex items-center gap-4">
              <div className="relative">
                <select 
                  value={reportFilter}
                  onChange={(e) => handleFilterChange(e.target.value as 'ALL' | 'YEARLY' | 'MONTHLY' | 'WEEKLY')}
